 ...
 * Generated at: 2021-01-01 20:26:16 UTC
...
public final class boardDetailView_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/views/board/../common/menubar.jsp", Long.valueOf(1608914483390L));
  }
...
if(loginUser==null){ 
 ...
 if(loginUser != null){ 
      ...
      out.write("\r\n");
      out.write("\t\t\t\t<td><textarea readonly rows=\"3\" cols=\"60\" id=\"replyContent\" style=\"resize:none;\">로그인한 사용자만 가능한 서비스입니다. 로그인 후 이용해주세요</textarea></td>\r\n");
      ...
      out.write("\t\t\t\t\ttype:\"post\", //내용이 길기 때문에 get보다는 post가 적합\r\n");
      out.write("\t\t\t\t\tdata:{\r\n");
