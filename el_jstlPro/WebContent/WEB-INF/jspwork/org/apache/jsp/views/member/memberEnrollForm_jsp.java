 ...
 * Generated at: 2021-01-27 05:58:20 UTC
...
public final class memberEnrollForm_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t<hr><br>\r\n");
      out.write("\t\t<form id=\"enrollForm\" method=\"POST\" class=\"was-validated\"> <!-- 모든 항목을 제대로 입력했는지 확인 -->\r\n");
      out.write("\t\t\t<!-- was-validated : form submit하기 전 유효한지 점검 / 유효하지 않은 형식에 대해 빨간 표시 -->\r\n");
      out.write("\t\t\t<!-- 아래부터 차례로 아이디, 비밀번호, 비밀번호 확인, 이름, 나이, 전화번호, 이메일을 각각 입력할 form-group div -->\r\n");
      out.write("\t\t\t<!-- 모두 required 처리해서 필수적으로 입력하도록 하였음 -->\r\n");
      out.write("\t\t\t<!-- form-group : 하위 label, input 등을 form-group으로 그룹화 후, form-group 간 아래 15px 여백 자동 처리 -->\r\n");
      out.write("\t\t\t<!-- form-control : input 크기를 full width로 지정 -->\r\n");
      out.write("\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t<label for=\"id\">아이디 : </label>\r\n");
      out.write("\t\t\t\t<input type=\"text\" class=\"form-control\" id=\"id\" placeholder=\"아이디를 입력하세요\" name=\"id\" required>\r\n");
      out.write("\t\t\t\t<div id=\"checkResult\" style=\"display:none; font-size=0.8em\"></div> <!-- 아이디 중복 체크 결과 나타낼 부분 -->\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t<label for=\"pwd\">비밀번호 : </label>\r\n");
      out.write("\t\t\t\t<input type=\"password\" class=\"form-control\" id=\"pwd\" placeholder=\"비밀번호를 입력하세요\" name=\"pwd\" required>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t<label for=\"pwd2\">비밀번호 확인 : </label>\r\n");
      out.write("\t\t\t\t<input type=\"password\" class=\"form-control\" id=\"pwd2\" placeholder=\"비밀번호를 확인\" name=\"pwd2\" required>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t<label for=\"userName\">이름 : </label>\r\n");
      out.write("\t\t\t\t<input type=\"text\" class=\"form-control\" id=\"userName\" placeholder=\"이름을 입력하세요\" name=\"userName\" required>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t<label for=\"age\">나이 : </label>\r\n");
      out.write("\t\t\t\t<input type=\"number\" class=\"form-control\" id=\"age\" placeholder=\"나이는 숫자로 입력하세요\" name=\"age\" required>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t<label for=\"phone\">전화번호 : </label>\r\n");
      out.write("\t\t\t\t<input type=\"number\" class=\"form-control\" id=\"phone\" placeholder=\"-없이 숫자로만 입력해주세요\" name=\"phone\" required>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t<label for=\"email\">이메일 : </label>\r\n");
      out.write("\t\t\t\t<input type=\"email\" class=\"form-control\" id=\"email\" placeholder=\"이메일을 입력해주세요\" name=\"email\" required>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t<label for=\"address\"> &nbsp; 주소 :</label>\r\n");
      out.write("            <div class=\"form-inline\">\r\n");
      out.write("\t\t\t\t<label> &nbsp; 우편번호 : &nbsp;</label>\r\n");
      out.write("\t\t\t\t<!-- mr : margin-right 간격 -->\r\n");
      out.write("\t\t\t\t<!-- 클래스명 postcodify_postcode5 : 새 우편번호 -->\r\n");
      ...
      out.write("\" size=\"30\" required>\r\n");
      out.write("\t\t\t<br>\r\n");
      out.write("\t\t\t<label> &nbsp; 상세주소 : </label>\r\n");
      out.write("\t\t\t<!-- 클래스명 postcodify_extra_info : 참고항목(법정동, 건물명 등) / 상세주소 -->\r\n");
      ...
      out.write("\t\t\t<script src=\"//d1p7wdleee1q2z.cloudfront.net/post/search.min.js\"></script> <!--postcodify api 설치 -->\r\n");
      out.write("\t\t\t<script>\r\n");
      out.write("\t\t\t\t// 검색 단추를 누르면 팝업 레이어가 열리도록 설정한다.\r\n");
      out.write("\t\t\t\t$(function(){\r\n");
      out.write("\t\t\t\t\t$(\"#postcodify_search_button\").postcodifyPopUp(); //postcodifyPopUp()은 postcodify api에서 제공되는 메소드\r\n");
      out.write("\t\t\t\t});\r\n");
      out.write("\t\t\t</script>\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t\t<button type=\"submit\" id=\"enrollBtn\" class=\"btn btn-primary\">가입하기</button>\r\n");
      out.write("\t\t\t<button type=\"button\" class=\"btn btn-danger\" onclick=\"goBack();\">취소하기</button>\r\n");
      out.write("\t\t</form>\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t<script>\r\n");
      out.write("\t\t\tfunction goBack(){ //취소하기 버튼 누르면 뒤로가기 처리하였음\r\n");
      out.write("\t\t\t\talert(\"뒤로 가기\");\r\n");
      out.write("\t\t\t\twindow.history.back();\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t//중복체크 여부에 따라 #enrollBtn 버튼의 disabled 여부 결정\r\n");
      ...
      out.write("\t    \t$(function(){\r\n");
      out.write("\t    \t\t\r\n");
      out.write("\t    \t\tvar $idInput = $(\"#enrollForm input[name=id]\"); // 아이디 입력하는 input 요소(input 태그의 name=id인 요소에 접근)\r\n");
      out.write("\t    \t\t\r\n");
      out.write("\t    \t\t$idInput.keyup(function(){\r\n");
      out.write("\t    \t\t\t\r\n");
      out.write("\t    \t\t\t// 아이디는 최소 5글자인 경우에 비동기 통신 실행\r\n");
