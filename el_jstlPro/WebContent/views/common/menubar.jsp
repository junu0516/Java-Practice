...
<body>
	...
	<!-- Modal -->
	<!-- 로그인 버튼 누르면 나올 팝업의 기능 -->
	<div class="modal" id="loginModal">
	<!-- sm : responsiveness to device -->
	    	...
	    	<div class="modal-content">
	            ...
	            <form id="loginForm" method="POST"> <!-- 팝업창 바디에 들어갈 로그인 폼 -->
	            	<div class="modal-body">
						<label for="loginId" class="mr-sm-2">아이디 : </label>
						<!-- form-control : full width form으로 크기 지정 -->
						<!-- mb2 : 위아래 간격 -->
						<!-- mr-sm-2 : 왼쪽 간격 -->
						<input type="text" class="form-control mb-2 mr-sm-2" id="loginId" placeholder="아이디를 입력하세요" name="loginId" required>
						<label for="loginPwd" class="mr-sm-2">비밀번호 : </label>
						<input type="password" class="form-control mb-2 mr-sm-2" id="loginPwd" placeholder="비밀번호를 입력하세요" name="loginPwd" required>
		            </div>
